...
`;
    ...
    // Starship uses TOML with $include directive
...
# Include the active preset configuration
"$include" = "${currentPresetPath}/starship.toml"

# Include user overrides (safe to customize)
"$include" = "${homeDir}/.config/starship-overrides.toml"
`;
