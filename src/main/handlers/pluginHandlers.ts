...
`;
    ...
    if (activePreset) {
      ...
      if (existsSync(presetConfigPath)) {
        ...
        const content = `# Ricekit Starship Configuration
# This file is auto-generated by Ricekit.
# Preset: ${activePreset}
#
...
`;
    ...
    if (activePreset) {
      ...
      if (existsSync(presetConfigPath)) {
        ...
        // Prepend Ricekit header
        content = `# Ricekit bat Configuration
# This file is auto-generated by Ricekit.
# Preset: ${activePreset}
...
async function generateDeltaGitconfig(
  ...
  const removeAllSections = (config: string, sectionName: string): string => {
    ...
    // Also removes preceding Ricekit comment if present
  ...
  // Append the delta sections with Ricekit header
  const ricekitHeader = `# Ricekit delta Configuration
# Preset: ${activePreset}
`;
  newConfig = newConfig.trimEnd() + '\n\n' + ricekitHeader + presetToAdd.trim() + '\n';
