        ...
        <div className="flex flex-col items-center gap-4 py-4">
          ...
          <div className="w-full space-y-4 text-sm">
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground">Developed by Ricekit Contributors</p>
            ...
            <div className="space-y-1">
              ...
              <div className="flex flex-col gap-1">
                <button
                  onClick={() => handleOpenExternal('https://github.com/ricekit/ricekit')}
                  className="text-left text-primary hover:underline"
                >
                  GitHub Repository
                </button>
                <button
                  onClick={() => handleOpenExternal('https://github.com/ricekit/ricekit/issues')}
                  className="text-left text-primary hover:underline"
                >
                  Report an Issue
                </button>
                <button
                  onClick={() => handleOpenExternal('https://github.com/ricekit/ricekit/blob/main/LICENSE')}
                  className="text-left text-primary hover:underline"
                >
                  License (MIT)
                </button>
          ...
          <p className="text-xs text-muted-foreground pt-2">
            © {new Date().getFullYear()} Ricekit Contributors. All rights reserved.
          </p>
        </div>
