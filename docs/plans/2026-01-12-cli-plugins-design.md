...
├─────────────────────────────────────────────────────────────┤
│  Ricekit current/ directory                                 │
│  ├── presets/<tool>/      ← Symlink to active preset        │
│  └── theme/<tool>-colors  ← Theme colors file               │
└─────────────────────────────────────────────────────────────┘
```

**Flow:** User selects preset → Ricekit creates wrapper config → wrapper sources (1) theme colors, (2) preset config, (3) user overrides.
...
```toml
# ~/.config/starship.toml - Generated by Ricekit
...
# Include preset
"$include" = "~/Library/Application Support/Ricekit/current/presets/starship/starship.toml"
...
```bash
# ~/.tmux.conf - Generated by Ricekit
source-file "~/Library/Application Support/Ricekit/current/theme/tmux-colors.conf"
source-file "~/Library/Application Support/Ricekit/current/presets/tmux/tmux.conf"
...
```bash
# ~/.config/bat/config - Generated by Ricekit
--theme="Ricekit"
...
- Ricekit should check if this exists in `.zshrc`/`.bashrc`
